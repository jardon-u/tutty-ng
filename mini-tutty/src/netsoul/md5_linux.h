 ...
 * ----------------------------------------------------------------------------
 *
 * $Id: md5_linux.h,v 1.3 2006/04/19 23:40:03 poulai_f Exp $
 *
 */
...
void	my_MD5Update(my_MD5_CTX *context, unsigned char const *buf, unsigned len);
void	MD5Final(unsigned char digest[MD5_HASHBYTES], my_MD5_CTX *context);
void	MD5Transform(u_int32_t buf[4], u_int32_t const in[16]);
char	*MD5End(my_MD5_CTX *, char *);
