 ...
 * ----------------------------------------------------------------------------
 *
 * $Id: md5_linux.c,v 1.3 2006/04/19 23:40:03 poulai_f Exp $
 *
 */
...
char *
MD5End(my_MD5_CTX *ctx, char *buf)
{
    int i;
 ...
 */
void my_MD5Init(my_MD5_CTX *ctx)
{
 ...
 * of bytes.
 */
void my_MD5Update(my_MD5_CTX *ctx, unsigned char const *buf, unsigned len)
{
    u_int32_t t;
 ...
 */
void MD5Final(unsigned char digest[16], my_MD5_CTX *ctx)
{
    unsigned count;
    unsigned char *p;
